...
zsh -li -c "mise settings set python_compile 1; mise use --global deno@latest go@latest python@latest python@2.7"
zsh -li -c "pip2 install --upgrade pip; pip install --upgrade pip"
