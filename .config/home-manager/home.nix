...
let
  ...
  mkPage = ids:
    builtins.genList
      (i: mkEntry (builtins.elemAt ids i) i)
      (builtins.length ids);
in
{
  ...
  home.packages = with pkgs; [
    mise croc fastfetch btop yazi
    neovim zellij
    wl-clipboard sqlite-interactive
    stow git 
    gh lazygit
    ...
    starship fzf atuin # Prompt improvement
...
# TODO: Do dotfiles folder management with home-manager
# TODO: keep all this dconf stuff in a different file
# TODO: implement directory structure by taking inspiration from system manager & the home manager docs
# TODO: Need to install kanata reliably (keep everything in 1 file)
  dconf = {
      enable = true;
    settings = {
        ...
        # - Set Alt+Space to trigger Vicinae alternative

# maybe vshell can do this folder & app layout
