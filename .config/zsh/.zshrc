...
zstyle ':fzf-tab:complete:cd:*' fzf-preview 'eza --color=always --icons=always --git --long --all --no-filesize --no-user --no-time --no-permissions $realpath'
zstyle ':fzf-tab:complete:__zoxide_z:*' fzf-preview 'eza --color=always --icons=always --git --long --all --no-filesize --no-user --no-time --no-permissions $realpath'
